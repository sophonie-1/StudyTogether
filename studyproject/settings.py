...
SECRET_KEY = 'django-insecure-26ipy6r@x7ti&=r5xv!t++%s2iv!4-eyy$p@yc*p-0t5nqnmb0'
...
LOGIN_REDIRECT_URL='myapp:home-view'
LOGOUT_REDIRECT_URL='myapp:login-user'
# Application definition
LOGIN_URL='myapp:login-user'
